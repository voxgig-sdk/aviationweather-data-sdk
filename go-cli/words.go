...
func registerSDKWords(r *eng.Registry, client *sdk.AviationweatherDataSDK) {
...
func runOp(client *sdk.AviationweatherDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
