...
// AviationweatherData SDK utility: fetcher

class AviationweatherDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AviationweatherDataSDK/1.0)';
    ...
    public static function call(AviationweatherDataContext $ctx, string $fullurl, array $fetchdef): array
    {
