...
class TcfDirectTest extends TestCase
{
    public function test_direct_load_tcf(): void
    {
        $setup = tcf_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-tcf", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
