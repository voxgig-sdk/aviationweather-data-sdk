...
class GAirmetDirectTest extends TestCase
{
    public function test_direct_list_g_airmet(): void
    {
        $setup = g_airmet_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-g_airmet", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
