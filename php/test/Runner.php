...
class AviationweatherDataTestRunner
{
    ...
    {
        $live = self::getenv('AVIATIONWEATHERDATA_TEST_LIVE');
        $override = self::getenv('AVIATIONWEATHERDATA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AVIATIONWEATHERDATA_TEST_EXPLAIN');
...
class_alias('AviationweatherDataTestRunner', 'Runner');
class_alias('AviationweatherDataHelpers', 'Helpers');
