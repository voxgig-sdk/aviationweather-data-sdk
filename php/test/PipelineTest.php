...
// AviationweatherData SDK pipeline test
//
...
{
    private static function utility(): AviationweatherDataUtility
    {
        return new AviationweatherDataUtility();
    }
    ...
    private static function ctx(array $over = []): AviationweatherDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AviationweatherDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AviationweatherDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AviationweatherDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AviationweatherDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AviationweatherDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AviationweatherDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AviationweatherDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AviationweatherDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AviationweatherDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AviationweatherDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AviationweatherDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AviationweatherDataResponse([]),
            'result' => new AviationweatherDataResult([]),
        ]);
        [, $err] = AviationweatherDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AviationweatherDataSpec([]),
            'response' => null,
            'result' => new AviationweatherDataResult([]),
        ]);
        [, $err] = AviationweatherDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AviationweatherDataSpec(['step' => 's']),
            'response' => new AviationweatherDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AviationweatherDataResult([]),
        ]);
        [, $err] = AviationweatherDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AviationweatherDataSpec(['step' => 's']),
            'response' => new AviationweatherDataResponse(self::resp(200, ['v' => 1])),
            'result' => new AviationweatherDataResult([]),
        ]);
        [, $err] = AviationweatherDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AviationweatherDataSpec(['step' => 's']),
            'response' => new AviationweatherDataResponse(self::resp(200, ['v' => 2])),
            'result' => new AviationweatherDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AviationweatherDataMakeResponse::call($ctx);
    ...
    {
        $preset = new AviationweatherDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AviationweatherDataSpec([]),
            'response' => new AviationweatherDataResponse([]),
            'result' => new AviationweatherDataResult([]),
        ...
        [$got, $err] = AviationweatherDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AviationweatherDataResult([])]);
        [, $err] = AviationweatherDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AviationweatherDataSpec([]), 'result' => null]);
        [, $err] = AviationweatherDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AviationweatherDataSpec(['step' => 's']),
            'result' => new AviationweatherDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AviationweatherDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AviationweatherDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AviationweatherDataSpec(['step' => 's']),
            'result' => new AviationweatherDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AviationweatherDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AviationweatherDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AviationweatherDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AviationweatherDataSpec([]),
            'result' => new AviationweatherDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AviationweatherDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AviationweatherDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AviationweatherDataError('boom', 'boom');
        $utility->fetcher = function (AviationweatherDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AviationweatherDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AviationweatherDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AviationweatherDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AviationweatherDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AviationweatherDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AviationweatherDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AviationweatherDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AviationweatherDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AviationweatherDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AviationweatherDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AviationweatherDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AviationweatherDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AviationweatherDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AviationweatherDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AviationweatherDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AviationweatherDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AviationweatherDataResult(['ok' => false])]);
        $this->expectException(AviationweatherDataError::class);
        AviationweatherDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AviationweatherDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AviationweatherDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AviationweatherDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AviationweatherDataBaseFeature();
        $b = new AviationweatherDataBaseFeature();
        AviationweatherDataFeatureAdd::call($ctx, $a);
        AviationweatherDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AviationweatherDataBaseFeature
    {
        $f = new AviationweatherDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AviationweatherDataFeatureAdd::call($ctx, self::named_feature('a'));
        AviationweatherDataFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AviationweatherDataFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AviationweatherDataFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AviationweatherDataFeatureAdd::call($ctx, $replace);
        ...
        AviationweatherDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AviationweatherDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AviationweatherDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AviationweatherDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AviationweatherDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AviationweatherDataResponse(['headers' => null]),
            'result' => new AviationweatherDataResult([]),
        ]);
        AviationweatherDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AviationweatherDataResultBody::call($ctx);
