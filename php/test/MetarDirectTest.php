...
class MetarDirectTest extends TestCase
{
    public function test_direct_list_metar(): void
    {
        $setup = metar_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-metar", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
