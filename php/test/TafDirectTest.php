...
class TafDirectTest extends TestCase
{
    public function test_direct_list_taf(): void
    {
        $setup = taf_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-taf", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
