...
class PirepDirectTest extends TestCase
{
    public function test_direct_list_pirep(): void
    {
        $setup = pirep_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pirep", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
