...
class CwaDirectTest extends TestCase
{
    public function test_direct_list_cwa(): void
    {
        $setup = cwa_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cwa", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
