...
class AirSigmetDirectTest extends TestCase
{
    public function test_direct_list_air_sigmet(): void
    {
        $setup = air_sigmet_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-air_sigmet", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
