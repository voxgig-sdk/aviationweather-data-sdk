...
// AviationweatherData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AviationweatherDataSDK::test)
...
{
    private const SDK_CLASS = 'AviationweatherDataSDK';
    ...
    private const SDK_BASE = 'aviationweatherdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../aviationweatherdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
