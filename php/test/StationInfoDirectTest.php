...
class StationInfoDirectTest extends TestCase
{
    public function test_direct_list_station_info(): void
    {
        $setup = station_info_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-station_info", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
