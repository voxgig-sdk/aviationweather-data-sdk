...
// AviationweatherData SDK Metar entity
...
class MetarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MetarEntity($this->_client, $opts);
    }

    /**
     * @param Metar|array $args Metar data (assoc-array) to store.
     */
    ...
    /**
     * @return Metar|array The current Metar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Metar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Metar fields).
     */
     ...
     *
     * @param MetarListMatch|array|null $reqmatch Match filter (any subset
     *   of Metar fields) as an assoc-array; MetarListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metar[]|array A list of Metar items as assoc-arrays at
