...
// AviationweatherData SDK Taf entity
...
class TafEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TafEntity($this->_client, $opts);
    }

    /**
     * @param Taf|array $args Taf data (assoc-array) to store.
     */
    ...
    /**
     * @return Taf|array The current Taf data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Taf fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Taf fields).
     */
     ...
     *
     * @param TafListMatch|array|null $reqmatch Match filter (any subset
     *   of Taf fields) as an assoc-array; TafListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Taf[]|array A list of Taf items as assoc-arrays at
