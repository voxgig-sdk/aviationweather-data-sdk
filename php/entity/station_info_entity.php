...
// AviationweatherData SDK StationInfo entity
...
class StationInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StationInfoEntity($this->_client, $opts);
    }

    /**
     * @param StationInfo|array $args StationInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return StationInfo|array The current StationInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StationInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StationInfo fields).
     */
     ...
     *
     * @param StationInfoListMatch|array|null $reqmatch Match filter (any subset
     *   of StationInfo fields) as an assoc-array; StationInfoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StationInfo[]|array A list of StationInfo items as assoc-arrays at
