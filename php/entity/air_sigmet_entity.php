...
// AviationweatherData SDK AirSigmet entity
...
class AirSigmetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AirSigmetEntity($this->_client, $opts);
    }

    /**
     * @param AirSigmet|array $args AirSigmet data (assoc-array) to store.
     */
    ...
    /**
     * @return AirSigmet|array The current AirSigmet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AirSigmet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AirSigmet fields).
     */
     ...
     *
     * @param AirSigmetListMatch|array|null $reqmatch Match filter (any subset
     *   of AirSigmet fields) as an assoc-array; AirSigmetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AirSigmet[]|array A list of AirSigmet items as assoc-arrays at
