...
// AviationweatherData SDK Pirep entity
...
class PirepEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PirepEntity($this->_client, $opts);
    }

    /**
     * @param Pirep|array $args Pirep data (assoc-array) to store.
     */
    ...
    /**
     * @return Pirep|array The current Pirep data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pirep fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pirep fields).
     */
     ...
     *
     * @param PirepListMatch|array|null $reqmatch Match filter (any subset
     *   of Pirep fields) as an assoc-array; PirepListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pirep[]|array A list of Pirep items as assoc-arrays at
