...
// AviationweatherData SDK idempotency feature
...
class AviationweatherDataIdempotencyFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _mutating(AviationweatherDataContext $ctx): bool
    {
