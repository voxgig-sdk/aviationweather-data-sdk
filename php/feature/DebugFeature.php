...
// AviationweatherData SDK debug feature
...
class AviationweatherDataDebugFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _finish(AviationweatherDataContext $ctx, bool $ok): void
    {
