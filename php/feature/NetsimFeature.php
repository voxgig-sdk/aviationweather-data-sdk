...
// AviationweatherData SDK netsim feature
...
class AviationweatherDataNetsimFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _simulate(AviationweatherDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AviationweatherDataContext $ctx, array $applied): void
    {
        $client = $this->client;
