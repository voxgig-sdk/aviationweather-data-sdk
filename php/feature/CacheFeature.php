...
// AviationweatherData SDK cache feature
...
class AviationweatherDataCacheFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _through(AviationweatherDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
