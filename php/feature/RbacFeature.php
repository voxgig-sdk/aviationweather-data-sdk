...
// AviationweatherData SDK rbac feature
...
class AviationweatherDataRbacFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _required(AviationweatherDataContext $ctx): ?string
    {
    ...
    private function _reject(AviationweatherDataContext $ctx, string $required): void
    {
    ...
    private function _track(AviationweatherDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
