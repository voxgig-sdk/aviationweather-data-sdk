...
// AviationweatherData SDK ratelimit feature
...
class AviationweatherDataRatelimitFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _acquire(AviationweatherDataContext $ctx): void
    {
    ...
    private function _track(AviationweatherDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
