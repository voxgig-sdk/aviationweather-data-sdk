...
// AviationweatherData SDK utility type

class AviationweatherDataUtility
{
    ...
    public static function copy(AviationweatherDataUtility $src): AviationweatherDataUtility
    {
        $u = new AviationweatherDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
