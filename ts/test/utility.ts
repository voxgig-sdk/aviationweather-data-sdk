...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.AVIATIONWEATHERDATA_TEST_LIVE ||
    'TRUE' === process.env.AVIATIONWEATHERDATA_TEST_OVERRIDE
  ) {
  ...
  m.AVIATIONWEATHERDATA_TEST_EXPLAIN = process.env.AVIATIONWEATHERDATA_TEST_EXPLAIN || m.AVIATIONWEATHERDATA_TEST_EXPLAIN
