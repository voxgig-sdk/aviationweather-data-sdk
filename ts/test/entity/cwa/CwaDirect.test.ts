...
describe('CwaDirect', async () => {
  ...
  test('direct-list-cwa', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-cwa', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['AVIATIONWEATHERDATA_TEST_CWA_ENTID']
