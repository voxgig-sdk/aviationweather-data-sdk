...
describe('TafDirect', async () => {
  ...
  test('direct-list-taf', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-taf', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['AVIATIONWEATHERDATA_TEST_TAF_ENTID']
