...
describe('GAirmetDirect', async () => {
  ...
  test('direct-list-g_airmet', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-g_airmet', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['AVIATIONWEATHERDATA_TEST_G_AIRMET_ENTID']
