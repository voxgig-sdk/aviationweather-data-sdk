...
describe('AirSigmetDirect', async () => {
  ...
  test('direct-list-air_sigmet', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-air_sigmet', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['AVIATIONWEATHERDATA_TEST_AIR_SIGMET_ENTID']
