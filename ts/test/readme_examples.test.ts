...
//     (\`new AviationweatherDataSDK(...)\` / \`AviationweatherDataSDK.test(...)\` become
//     \`AviationweatherDataSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'AviationweatherDataSDK'
...
const TEST_SEED = {"entity":{"air_sigmet":{"test01":{"id":"test01"}},"airport":{"test01":{"id":"test01"}},"cache":{"test01":{"id":"test01"}},"cwa":{"test01":{"id":"test01"}},"g_airmet":{"test01":{"id":"test01"}},"metar":{"test01":{"id":"test01"}},"pirep":{"test01":{"id":"test01"}},"station_info":{"test01":{"id":"test01"}},"taf":{"test01":{"id":"test01"}},"tcf":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new AviationweatherDataSDK(...)\` and any
// \`AviationweatherDataSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+AviationweatherDataSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/AviationweatherDataSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
