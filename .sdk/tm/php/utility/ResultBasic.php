...
// AviationweatherData SDK utility: result_basic

class AviationweatherDataResultBasic
{
    public static function call(AviationweatherDataContext $ctx): ?AviationweatherDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AviationweatherDataError) ? $result->err->msg : (string)$result->err;
