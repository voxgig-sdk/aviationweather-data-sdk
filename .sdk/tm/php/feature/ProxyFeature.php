...
// AviationweatherData SDK proxy feature
...
class AviationweatherDataProxyFeature extends AviationweatherDataBaseFeature
{
    ...
    public function init(AviationweatherDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AviationweatherDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
