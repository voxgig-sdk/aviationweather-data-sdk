...
// AviationweatherData SDK audit feature
...
class AviationweatherDataAuditFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _emit(AviationweatherDataContext $ctx, string $outcome): void
    {
