...
// AviationweatherData SDK streaming feature
...
class AviationweatherDataStreamingFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _iterate(AviationweatherDataResult $result): \Generator
    {
    ...
    private function _streamable(AviationweatherDataContext $ctx): bool
    {
