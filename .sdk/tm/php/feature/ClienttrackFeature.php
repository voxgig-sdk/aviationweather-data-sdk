...
// AviationweatherData SDK clienttrack feature
...
class AviationweatherDataClienttrackFeature extends AviationweatherDataBaseFeature
{
    ...
    public function PostConstruct(AviationweatherDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AviationweatherData-SDK';
