...
// AviationweatherData SDK timeout feature
...
class AviationweatherDataTimeoutFeature extends AviationweatherDataBaseFeature
{
    ...
    private function _with_timeout(AviationweatherDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AviationweatherDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
