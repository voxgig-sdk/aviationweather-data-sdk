...
from projectname_sdk import AviationweatherDataSDK
from core.spec import AviationweatherDataSpec
from core.result import AviationweatherDataResult
from core.response import AviationweatherDataResponse
from core.operation import AviationweatherDataOperation
from core.error import AviationweatherDataError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return AviationweatherDataError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except AviationweatherDataError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = AviationweatherDataResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = AviationweatherDataSDK.test(None, None)
        ...
        class TestInitFeature(AviationweatherDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AviationweatherDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = AviationweatherDataSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = AviationweatherDataSDK({
            "system": {
                "fetch": mock_fetch,
            },
        })
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AviationweatherDataSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AviationweatherDataSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = AviationweatherDataOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AviationweatherDataSDK.test(None, setup_opts)
