// Command AviationweatherData-mcp is an MCP server exposing the AviationweatherData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AviationweatherData_list  — list records of an entity
//	AviationweatherData_load  — load a single record of an entity
//
