...
from aviationweatherdata_types import (
    StationInfo,
...
class StationInfoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StationInfoEntity(self._client, opts)
    ...
    def match_get(self) -> StationInfo:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[StationInfo]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.StationInfo().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
