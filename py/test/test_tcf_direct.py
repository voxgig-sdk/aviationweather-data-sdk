...
class TestTcfDirect:
    ...
    def test_should_direct_load_tcf(self):
        setup = _tcf_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-tcf", "live" if setup["live"] else "unit")
        if _skip:
