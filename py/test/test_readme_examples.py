# AviationweatherData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AviationweatherDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AviationweatherDataSDK(...) and AviationweatherDataSDK.test(...) become
#      AviationweatherDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "aviationweatherdata_sdk"
_SDK_CLASS = "AviationweatherDataSDK"
