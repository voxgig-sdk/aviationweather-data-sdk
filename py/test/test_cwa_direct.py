...
class TestCwaDirect:
    ...
    def test_should_direct_list_cwa(self):
        setup = _cwa_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-cwa", "live" if setup["live"] else "unit")
        if _skip:
