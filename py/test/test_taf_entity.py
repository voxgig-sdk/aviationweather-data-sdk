...
class TestTafEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.Taf(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.Taf(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        taf_ref01_list_result = taf_ref01_ent.list(taf_ref01_match, None)
