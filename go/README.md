...
The Golang SDK for the AviationweatherData API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/aviationweather-data-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/aviationweather-data-sdk=../path/to/github.com/voxgig-sdk/aviationweather-data-sdk
```
...
```
github.com/voxgig-sdk/aviationweather-data-sdk/
...
The root package (`github.com/voxgig-sdk/aviationweather-data-sdk`) re-exports everything needed
