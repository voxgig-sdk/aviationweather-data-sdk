...
const testSeed = `map[string]any{"entity": map[string]any{"air_sigmet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "airport": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cache": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cwa": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "g_airmet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pirep": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "station_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "taf": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tcf": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
