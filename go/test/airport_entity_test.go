...
func TestAirportEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set AVIATIONWEATHERDATA_TEST_AIRPORT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func airportBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("AVIATIONWEATHERDATA_TEST_AIRPORT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["AVIATIONWEATHERDATA_TEST_AIRPORT_ENTID"])
