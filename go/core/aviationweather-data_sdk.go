...
type AviationweatherDataSDK struct {
	Mode     string
...
func (sdk *AviationweatherDataSDK) OptionsMap() map[string]any {
...
func (sdk *AviationweatherDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AviationweatherDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AviationweatherDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AviationweatherDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AviationweatherDataSDK {
	...
	sdk := NewAviationweatherDataSDK(sdkopts)
	sdk.Mode = "test"
