...
#      offline in seeded test mode (AviationweatherDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AviationweatherData_sdk.rb")
  SDK_CLASS = "AviationweatherDataSDK"
  ...
  SDK_BASE = "AviationweatherData_sdk"
