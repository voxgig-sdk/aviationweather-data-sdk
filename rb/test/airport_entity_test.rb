...
class AirportEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AVIATIONWEATHERDATA_TEST_AIRPORT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def airport_basic_setup(extra)
  ...
  entid_env_raw = ENV["AVIATIONWEATHERDATA_TEST_AIRPORT_ENTID"]
