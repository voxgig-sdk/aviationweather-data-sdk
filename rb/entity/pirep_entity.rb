...
class PirepEntity
  ...
  #
  # @param reqmatch [PirepListMatch, Hash, nil] match filter (any subset of
  #   Pirep fields); defaults to nil, treated as an empty match that lists all.
