...
class StationInfoEntity
  ...
  def make
    opts = @_entopts.dup
    StationInfoEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [StationInfoListMatch, Hash, nil] match filter (any subset of
  #   StationInfo fields); defaults to nil, treated as an empty match that lists all.
