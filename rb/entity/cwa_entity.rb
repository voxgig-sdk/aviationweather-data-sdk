...
class CwaEntity
  ...
  #
  # @param reqmatch [CwaListMatch, Hash, nil] match filter (any subset of
  #   Cwa fields); defaults to nil, treated as an empty match that lists all.
