...
class GAirmetEntity
  ...
  def make
    opts = @_entopts.dup
    GAirmetEntity.new(@_client, opts)
  end
  ...
  # @return [GAirmet, Hash] the current GAirmet data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GAirmet fields)
  def match_get
  ...
  #
  # @param reqmatch [GAirmetListMatch, Hash, nil] match filter (any subset of
  #   GAirmet fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GAirmet>, Array] the matching GAirmet items; raises AviationweatherDataError on failure
