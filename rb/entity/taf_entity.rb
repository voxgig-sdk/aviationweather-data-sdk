...
class TafEntity
  ...
  #
  # @param reqmatch [TafListMatch, Hash, nil] match filter (any subset of
  #   Taf fields); defaults to nil, treated as an empty match that lists all.
