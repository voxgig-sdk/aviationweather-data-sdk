...
class MetarEntity
  ...
  #
  # @param reqmatch [MetarListMatch, Hash, nil] match filter (any subset of
  #   Metar fields); defaults to nil, treated as an empty match that lists all.
