...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/aviationweather-data` | `npm install @voxgig-sdk/aviationweather-data` |
| Python | `voxgig-sdk-aviationweather-data` | `pip install voxgig-sdk-aviationweather-data` |
| PHP | `voxgig-sdk/aviationweather-data` | `composer require voxgig-sdk/aviationweather-data` |
| Golang | `github.com/voxgig-sdk/aviationweather-data-sdk/go` | `go get github.com/voxgig-sdk/aviationweather-data-sdk/go` |
| Ruby | `voxgig-sdk-aviationweather-data` | `gem install voxgig-sdk-aviationweather-data` |
| Lua | `voxgig-sdk-aviationweather-data` | `luarocks install voxgig-sdk-aviationweather-data` |
