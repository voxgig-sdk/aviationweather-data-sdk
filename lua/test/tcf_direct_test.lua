...
describe("TcfDirect", function()
  it("should direct-load-tcf", function()
    local setup = tcf_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tcf", setup.live and "live" or "unit")
...
function tcf_direct_setup(mockres)
