...
describe("StationInfoDirect", function()
  it("should direct-list-station_info", function()
    local setup = station_info_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-station_info", setup.live and "live" or "unit")
...
function station_info_direct_setup(mockres)
