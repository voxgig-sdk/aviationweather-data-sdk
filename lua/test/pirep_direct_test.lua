...
describe("PirepDirect", function()
  it("should direct-list-pirep", function()
    local setup = pirep_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pirep", setup.live and "live" or "unit")
...
function pirep_direct_setup(mockres)
