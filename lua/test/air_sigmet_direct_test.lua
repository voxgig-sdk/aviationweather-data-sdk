...
describe("AirSigmetDirect", function()
  it("should direct-list-air_sigmet", function()
    local setup = air_sigmet_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-air_sigmet", setup.live and "live" or "unit")
...
function air_sigmet_direct_setup(mockres)
