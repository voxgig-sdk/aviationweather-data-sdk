...
describe("CwaDirect", function()
  it("should direct-list-cwa", function()
    local setup = cwa_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cwa", setup.live and "live" or "unit")
...
function cwa_direct_setup(mockres)
