...
function runner.env_override(m)
  local live = runner.getenv("AVIATIONWEATHERDATA_TEST_LIVE")
  local override = runner.getenv("AVIATIONWEATHERDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AVIATIONWEATHERDATA_TEST_EXPLAIN")
