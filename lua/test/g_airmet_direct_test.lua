...
describe("GAirmetDirect", function()
  it("should direct-list-g_airmet", function()
    local setup = g_airmet_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-g_airmet", setup.live and "live" or "unit")
...
function g_airmet_direct_setup(mockres)
