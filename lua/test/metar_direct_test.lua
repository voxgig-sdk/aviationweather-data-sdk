...
describe("MetarDirect", function()
  it("should direct-list-metar", function()
    local setup = metar_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-metar", setup.live and "live" or "unit")
...
function metar_direct_setup(mockres)
