...
describe("TafDirect", function()
  it("should direct-list-taf", function()
    local setup = taf_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-taf", setup.live and "live" or "unit")
...
function taf_direct_setup(mockres)
