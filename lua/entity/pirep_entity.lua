...
local PirepEntity = {}
PirepEntity.__index = PirepEntity


function PirepEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PirepEntity)
  self._name = "pirep"
  self._client = client
...
function PirepEntity:get_name()
  return self._name
end


function PirepEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PirepEntity.new(self._client, opts)
end


function PirepEntity:data_set(args)
  if args ~= nil then
...
function PirepEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PirepEntity:match_set(args)
  if args ~= nil then
...
function PirepEntity:match_get()
...
function PirepEntity:stream(action, args, callopts)
...
function PirepEntity:_run_op(ctx, post_done)
  local utility = self._utility
