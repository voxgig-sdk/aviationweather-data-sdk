-- AviationweatherData SDK GAirmet entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local GAirmetEntity = {}
GAirmetEntity.__index = GAirmetEntity


function GAirmetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GAirmetEntity)
  self._name = "g_airmet"
  self._client = client
...
function GAirmetEntity:get_name()
  return self._name
end


function GAirmetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GAirmetEntity.new(self._client, opts)
end


function GAirmetEntity:data_set(args)
  if args ~= nil then
...
function GAirmetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GAirmetEntity:match_set(args)
  if args ~= nil then
...
function GAirmetEntity:match_get()
...
function GAirmetEntity:stream(action, args, callopts)
...
---@param reqmatch GAirmetListMatch
---@param ctrl? table
---@return GAirmet[]
---@return string? err
function GAirmetEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GAirmetEntity:_run_op(ctx, post_done)
  local utility = self._utility
