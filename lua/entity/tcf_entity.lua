...
local TcfEntity = {}
TcfEntity.__index = TcfEntity


function TcfEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TcfEntity)
  self._name = "tcf"
  self._client = client
...
function TcfEntity:get_name()
  return self._name
end


function TcfEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TcfEntity.new(self._client, opts)
end


function TcfEntity:data_set(args)
  if args ~= nil then
...
function TcfEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TcfEntity:match_set(args)
  if args ~= nil then
...
function TcfEntity:stream(action, args, callopts)
...
function TcfEntity:_run_op(ctx, post_done)
  local utility = self._utility
